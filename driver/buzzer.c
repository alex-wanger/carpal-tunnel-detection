...
{
    if (x < BUZZ_THR_X_NEG) return true;
    if (x > BUZZ_THR_X_POS) return true;
    if (y > BUZZ_THR_Y_POS) return true;
    if (y < BUZZ_THR_Y_NEG) return true;
    if (z > BUZZ_THR_Z_POS) return true;
    if (z < BUZZ_THR_Z_NEG) return true;
    return false;
}
